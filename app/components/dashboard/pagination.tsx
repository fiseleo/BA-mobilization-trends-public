...
}> = ({ currentPage, totalItems, itemsPerPage, onPageChange, onItemsPerPageChange, onLoadMore, onScrollToTop }) => {
                ...
                <div className="flex items-center text-sm text-neutral-600 dark:text-neutral-400 px-2">
                    <form onSubmit={handleFormSubmit}>
                        <input
                            ...
                            className="w-14 h-9 rounded-md border border-neutral-300 bg-white dark:bg-neutral-800 text-center text-neutral-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-neutral-500 dark:border-neutral-700 transition"
                        />
                    </form>
